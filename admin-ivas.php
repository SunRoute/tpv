        ...
        <div id="addArticle" class="modal fade" tabindex="-1" aria-labelledby="addArticleLabel" aria-hidden="true">
            <div class="modal-dialog">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="addArticleLabel">ADMINISTRACIÓN IVA</h5>    
                ...
                <div class="modal-body">
                    ...
                    <form class="admin-form" data-route="storeIva">
                        ...
                        <div class="mb-3">
                            <label for="tipo" class="form-label">IVA (%)</label>
    ...
    <div>
        <div id="deleteArticle" class="modal fade" tabindex="-1" aria-labelledby="deleteArticleLabel" aria-hidden="true">
            <div class="modal-dialog">
                ...
                <div class="modal-body">
                    <p class="text-center text-muted">Está a punto de borrar un IVA. ¿Está completamente seguro de realizar esta acción?</p>
                </div>
