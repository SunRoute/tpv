                    ...
                    <div class="row">
                        <div class="col">
                            <ol class="breadcrumb mb-0 mt-3">
                                ...
                                <li class="breadcrumb-item"><a href="categorias.php?categoria=<?php echo $_GET['categoria']?>"><span><i class="icon ion-social-buffer-outline me-2"></i>Categoría</span></a></li>
