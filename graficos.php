            ...
            <div class="col-12 col-lg-5 col-xl-4 mt-5">
                <aside>
                    ...
                    <div class="list-group">
                        ...
                        <div class="chart-item list-group-item list-group-item-action" data-route="getSaleChartData" data-chart="average_by_day" data-type="bar" aria-current="true">
                            <div class="d-flex w-100 justify-content-between">
                                <h5 class="mb-1">Media venta por día</h5>
                            </div>
                        </div>

                        <div class="chart-item list-group-item list-group-item-action" data-route="getSaleChartData" data-chart="average_by_month" data-type="bar" aria-current="true">
                            <div class="d-flex w-100 justify-content-between">
                                <h5 class="mb-1">Media venta por mes</h5>
                            </div>
                        </div>

                        <div class="chart-item list-group-item list-group-item-action" data-route="getSaleChartData" data-chart="average_by_year" data-type="bar" aria-current="true">
                            <div class="d-flex w-100 justify-content-between">
                                <h5 class="mb-1">Media venta por año</h5>
                            </div>
                        </div>
